...
void TestCreateReserveCapacitySize()
{
    Obj::ResetCounters();
...
void TestCorrectFallWithExceptionInConstructOrCopy()
{
...
void TestMoveConstructAndReserve()
{
...
void TestIteratorsEmplaceInsertErase()
{
    using namespace std::literals;
...
int main()
{
    try
    {
        TestCreateReserveCapacitySize();
        TestCorrectFallWithExceptionInConstructOrCopy();
        TestMoveConstructAndReserve();
        TestResizeAndPushBack();
        TestEmplaceBack();
        TestIteratorsEmplaceInsertErase();
        Benchmark();
    }
